...
class CoordConv(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, kernel_size,
        ...
        # grouped convs needs merged
        self.is_group_convs = False
        if groups > 1: 
            self.is_group_convs = True
            self.merge_layer = nn.Conv2d(in_channels, ori_in_channels, 1)
        else:
            ori_in_channels = in_channels

        self.conv_layer = nn.Conv2d(ori_in_channels, out_channels,
